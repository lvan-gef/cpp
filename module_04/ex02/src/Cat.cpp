...
/*   Updated: 2024/03/29 20:55:30 by lvan-gef      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
Cat::Cat(const Cat &rhs) : AAnimal(rhs), brain_(new Brain(*rhs.brain_)) {
...
Cat::Cat(Cat &&rhs) noexcept : AAnimal(std::move(rhs)), brain_(rhs.brain_) {

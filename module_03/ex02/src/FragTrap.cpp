...
/*   Updated: 2024/03/05 15:48:40 by lvan-gef      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
FragTrap::FragTrap(const std::string &name) : ClapTrap(name) {
  std::cout << "Constructor with name called for FragTrap with name: " << _name
            << std::endl;
  this->_name = _name;
  this->_points = 100;
  this->_energy = 100;
...
void FragTrap::highFivesGuys(void) const {
  if (this->_points > 0) {
    std::cout << "Lets highfives if you have to energy for it..." << std::endl;
  }
}

...
static void vectorTest() {
    ...
    assert(ms_vec.top() == og_vec.top() && "Own and Og should be the seem: {1, 2, 3}");
...
void testComplexTypes() {
    ...
    assert(og_complex.size() == og_complex.size() && "Own and Og should be the same size: 2");
    assert(og_complex.top() == og_complex.top() && "Own and Og should be the seem: second, {4, 5, 6}");
    ...
    assert(ms_complex.size() == og_complex.size() && "Own and Og should be the same size: 1");
    assert(ms_complex.top() == og_complex.top() && "Own and Og should be the seem: first, {1, 2, 3}");

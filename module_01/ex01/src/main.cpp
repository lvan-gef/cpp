...
int main(void) {
  ...
  if (zombies == NULL) {
    std::cout << "How to give commands to a army if a zombie hase no name??\n";
  } else {
    std::cerr << "I'm magic, i can give commands to a army while a zombie hase "
                 "no names :)\n";
  }
  std::cout << "\n";
  delete[] zombies;
  ...
  if (zombies == NULL) {
    ...
    std::cout << "I'm magic, i can give commands to a army of zombies while "
